...
//        author.setAge(21);
//        authorDaoUnderTest.update(author, author.getId());
//        Optional<Author> result = authorDaoUnderTest.getAuthorById(author.getId());
...
//        authorDaoUnderTest.create(author);
//
//        authorDaoUnderTest.deleteAuthorById(author.getId());
//
//        Optional<Author> result = authorDaoUnderTest.getAuthorById(author.getId());
//
