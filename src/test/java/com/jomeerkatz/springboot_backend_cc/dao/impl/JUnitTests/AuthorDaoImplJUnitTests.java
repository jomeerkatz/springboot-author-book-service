...
public class AuthorDaoImplJUnitTests {
    ...
    // update all
    @Test
    public void testThatCreateCorrectSQLUpdateAuthors() {
        // create author
        Author author = TestDataUtil.createTestAuthor();

        // update author
        authorDaoImplUnderTest.update(author, 1L);

        // check if this query was executed
        verify(jdbcTemplate).update(
    ...
    @Test
    public void testThatCreateCorrectSQLDeleteAuthors () {
        authorDaoImplUnderTest.deleteAuthorById(1L);
